...
import { infoUserName, toggleEditState } from "../../redux/loginSlice";
...
const EditName = () => {
  ...
  const userProfile = login.userProfile.body;
  
  // Initialisation de la variable avec le store par défaut et onChange pour récupérer la valeur de l'input
